...
function api_v1_lee_list(payload) {
  return tstmbkadfaslksdsdAPI.get(`/api/v1/lee/`)
}
function api_v1_lee_create(payload) {
  return tstmbkadfaslksdsdAPI.post(`/api/v1/lee/`, payload.data)
}
function api_v1_lee_retrieve(payload) {
  return tstmbkadfaslksdsdAPI.get(`/api/v1/lee/${payload.id}/`)
}
function api_v1_lee_update(payload) {
  return tstmbkadfaslksdsdAPI.put(`/api/v1/lee/${payload.id}/`, payload.data)
}
function api_v1_lee_partial_update(payload) {
  return tstmbkadfaslksdsdAPI.patch(`/api/v1/lee/${payload.id}/`, payload.data)
}
function api_v1_lee_destroy(payload) {
  return tstmbkadfaslksdsdAPI.delete(`/api/v1/lee/${payload.id}/`)
}
